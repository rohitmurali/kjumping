...
public class BoardTest {
    ...
    public void testSet() {
        ...
        C.set(2, 1, 3, RED);
        assertEquals("wrong number of spots", 1, C.get(2, 2).getSpots());
        assertEquals("wrong color", RED, B.get(2, 2).getSide());
        assertEquals("wrong number of spots", 3, C.get(2, 1).getSpots());
    ...
    public void testMove() {
        ...
        B.undo();
        checkBoard("#0U", B);
        checkBoard("#C", C, 1, 1, 1, RED, 2, 1, 3, RED, 1, 2, 2, RED);
        C.clear(8);
        checkBoard("#Clear", C);
